...
export const generateLibrary = (resourceName, options, projectName) =>
  generateComponent('g library', resourceName, options, projectName);

export const generateApi = (resourceName, options, projectName) => {
  generateModule(resourceName, options, projectName);
  generateController(resourceName, options, projectName);
  generateService(resourceName, options, projectName);
};
